...
public class Shipment 
{
	...
	public void VerifyShipmentButtonTap() throws InterruptedException 
	{
		...
		//click menu
		Thread.sleep(8000);
		WebDriverWait menu_btn= new WebDriverWait(Login.driver, 30);
		try {
	 ...
	 Dimension size = menu_view.getSize();
	   ...
	   .moveTo(PointOption.point(ScreenPlace,endPoint)).release().perform();
	  	Thread.sleep(1500);
	  	 WebDriverWait detail_page= new WebDriverWait(Login.driver, 50);
    ...
    catch (Exception e) 
    {
	 ...
	 WebDriverWait selt_inv= new WebDriverWait(Login.driver, 30);
	 ...
	 {
		 WebDriverWait popup= new WebDriverWait(Login.driver, 30);
		 ...
		 WebElement max=  Login.driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View[2]/android.view.View[2]/android.view.View[2]/android.view.View[1]/android.view.View/android.view.View[7]/android.view.View/android.widget.EditText\n" + 
		 		""));
		 max.sendKeys("15");
		 
		 WebElement par=  Login.driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View[2]/android.view.View[2]/android.view.View[2]/android.view.View[1]/android.view.View/android.view.View[8]/android.view.View/android.widget.EditText"));
		 par.sendKeys("7");
			 
		 WebElement add_to_inventory=  Login.driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View[2]/android.view.View[2]/android.view.View[3]/android.widget.Button[2]\n" + 
		 		""));
