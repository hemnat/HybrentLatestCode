...
public class Cycle_Count
{
	...
	WebDriverWait int_cycle= new WebDriverWait(Login.driver, 40);
	try
	{
	...
	WebElement Select_Inv=  int_cycle.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.view.View[@content-desc=\"Select\"]/android.widget.TextView\n" + 
			"")));
	Select_Inv.click();
	Thread.sleep(1000);
	...
	Thread.sleep(1000);
				  ...
				  WebElement Counted_Item=  int_cycle2.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("	//android.view.View[@content-desc=\"0Counted Items\"]")));
				  Counted_Item.click();
				  Thread.sleep(1000);
				  
				    WebElement NewItem= int_cycle2.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.view.View[@content-desc=\"New Item\"]\n" + 
				    		"")));
				    NewItem.click();
					Thread.sleep(1000);
