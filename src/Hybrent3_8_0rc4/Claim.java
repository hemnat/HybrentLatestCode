...
public class Claim {
	...
	catch (Exception e) 
	{
	  ...
	  WebElement select_patient=  select_ptnt.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.view.View[@content-desc=\"Select New RESIDENT\"]/android.widget.TextView\n" + 
	  		"")));
