...
public class Warehouse 
{
	...
	public void IncreaseItemQuantity() throws InterruptedException 
	{
		...
		WebElement Increase_qty=increase.until(ExpectedConditions.visibilityOfElementLocated(AppiumBy.xpath("//android.view.View[@content-desc=\"ï?•\"]/android.widget.TextView")));
		Increase_qty.click();
		Thread.sleep(2000);
