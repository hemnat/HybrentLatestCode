...
public class CustomReporter implements IReporter
{
	...
	private static final String emailableReportTemplateFile = "C:\\Users\\Admin\\git\\Hybrent-Mobile\\Hybrent_Mobile_Automation\\src\\Hybrent3_8_0rc4\\custom-emailable-report.html";
		...
		try
		{
			...
			for(ISuite tempSuite: suites)
			{
				...
				for (ISuiteResult result : testResults.values()) {
					...
					/* Get browser type. */
					String Plateform_Name = tempSuite.getParameter("browserType");
					if(Plateform_Name==null || Plateform_Name.trim().length()==0)
					{
