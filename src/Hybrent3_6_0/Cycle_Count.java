...
public class Cycle_Count
{
				...
				
 {
	...
	WebElement StartCount=   int_cycle2.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.view.View[@content-desc=\"Start Count\"]/android.view.View")));
	StartCount.click();
	Thread.sleep(1000);
