...
public class Templates {
	...
	public void Verify_OrderTemplate() throws InterruptedException 
	{
		...
		WebDriverWait menu1= new WebDriverWait(Login.driver, 10);
		try 
		{
	...
	Reporter.log("=====Scan_out Template Started sucessfully=====", true);
      ...
      {
    	  WebElement Scan_out_Template=  menu2.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("	//android.view.View[@content-desc=\"Scan Out\"]")));
    	    Scan_out_Template.click();
    		Reporter.log("=====Scan_out Template Started sucessfully=====", true);
	}
	}
