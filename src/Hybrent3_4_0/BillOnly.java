...
public class BillOnly 
{
	...
	@Test(priority = 24)
	public void Bill_Only() throws InterruptedException 
	{
	 ...
	 //click menu
		...
		catch (Exception e) 
		{
		 ...
		 Dimension size11 = menu_view.getSize();
		    ...
		    System.out.println(size11.width+"width");
		     ...
		     int endPoint11 = (int) (size11.height *0.2);
	     ...
	     WebDriverWait add_cse= new WebDriverWait(Login.driver, 50);
		 WebElement add_case=  add_cse.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View[3]/android.view.View/android.view.View[2]/android.widget.Button\n" + 
		 		"")));
		 add_case.click();
		 Thread.sleep(7000);
		 
		 WebElement select_patient=   add_cse.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View[3]/android.view.View/android.view.View/android.view.View[1]/android.view.View[1]/android.view.View[1]/android.view.View[2]/android.view.View[2]/android.view.View\n" + 
		 		"")));
		 ...
		 WebDriverWait add_cse1= new WebDriverWait(Login.driver, 30);
		 ...
		 Thread.sleep(2000);
		  ...
		  WebElement add_caseno= add_cse1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View[3]/android.view.View/android.view.View/android.view.View[1]/android.view.View[1]/android.view.View[1]/android.view.View[8]/android.view.View[2]/android.view.View/android.view.View\n" + 
			 		"")));
		  add_caseno.click();
		  Thread.sleep(4000);
		  
		  WebDriverWait add_cse2= new WebDriverWait(Login.driver, 30);
		  WebElement enter_caseno= add_cse2.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View[3]/android.view.View/android.view.View/android.view.View[1]/android.view.View[1]/android.view.View[1]/android.view.View[9]/android.widget.EditText")));
		  enter_caseno.click();
		  case_no="Test"+getAlphaNumericString(5);
		  enter_caseno.sendKeys(case_no);
		  Thread.sleep(4000);
		 ...
		 WebDriverWait add_cse3= new WebDriverWait(Login.driver, 30);
		 try
		 {
		 ...
		 WebDriverWait add_cse4= new WebDriverWait(Login.driver, 30);
		...
		TouchAction ts1 = new TouchAction(Login.driver);
		 ...
		 WebDriverWait add_sign1= new WebDriverWait(Login.driver, 30);
