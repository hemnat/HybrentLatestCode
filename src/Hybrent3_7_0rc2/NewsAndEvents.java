...
public class NewsAndEvents 
{
	...
	public void VerifyNewsAndEventsButtonTap() throws InterruptedException 
	{
	 ...
	 //click menu
		...
		catch (Exception e) 
		{
	     ...
	     try
	     {
	    	 WebElement NewsandEvents_get= click.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View[1]/android.view.View/android.view.View[1]\n" + 
		  	    		"")));
	...
	@Test(priority = 61)
	  public void VerifyNewsDescriptionScreen() throws InterruptedException 
	  {
		 ...
		 try
		 {
		 WebElement Cancel_news=  add_cse2.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View[1]/android.view.View/android.view.View[2]/android.view.View[1]/android.view.View/android.view.View[2]/android.view.View[2]\n" + 
		 		"")));
		 Cancel_news.click();
		 Thread.sleep(1000);
		 }
